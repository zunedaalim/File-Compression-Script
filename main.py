    ...
    class HeapNode:
        ...
        def __eq__(self, other):
            ...
            if not isinstance(other, HuffmanCoding.HeapNode):
                return False
            return self.freq == other.freq  # Fixed comparison
...
if __name__ == "__main__":
    ...
    file_path = "check.txt"  # Make sure input.txt is in the same folder

    # Create HuffmanCoding instance with the file path
    ...
    print(f"File decompressed and saved as: {decompressed_file}")
